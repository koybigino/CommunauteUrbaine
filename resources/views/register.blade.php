<x-auth title="Register">
    <div class="px-6 py-4">
        ...
        <p class="mt-1 text-center text-gray-800">Creer un compte</p>
    </div>
    ...
    <label for="dropzone-file"
        class="flex items-center px-3 py-3 mx-auto mt-6 text-center bg-transparent border-2 border-dashed rounded-lg cursor-pointer">
