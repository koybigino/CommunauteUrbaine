<div class="md:flex md:items-center md:justify-center md:w-1/2 md:bg-white md:">
    <div class="px-6 py-6 md:px-8 md:py-0">
        <h2 class="text-lg font-bold text-gray-700">Sign Up pour la mise à jour des <span
