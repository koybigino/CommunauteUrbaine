<div x-data="{ isOpen: false }" class="relative flex justify-center">
    <button @click="isOpen = true" class="p-4 mx-auto tracking-wide text-white capitalize transition-colors duration-300 transform bg-white rounded-full hover:scale-105">
