<div class="lg:flex bg-white px-6 py-10 mx-auto rounded-xl shadow">
    <div class="flex items-center justify-center w-full px-6 py-8 lg:w-1/2">
        <div class="max-w-xl">
            <h2 class="text-3xl font-semibold text-gray-800 lg:text-4xl">Bienvenu dans la mairie de <span class="text-green-400">Yaounde VI</span></h2>
    ...
    <div class="w-full h-64 lg:w-1/2 transition duration-500 ease-in-out transform hover:scale-105">
