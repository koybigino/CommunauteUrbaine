<div class="max-w-screen-xl mx-auto px-10 pb-10">
    <h1 class="text-2xl mb-10 font-semibold text-center text-gray-800 capitalize lg:text-3xl "><span
            class="text-green-500">Services</span></h1>
    ...
    <div class="grid content-center grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
        <div
            ...
            <a href="/">
                ...
                <p class="text-sm p-2">
                    demande de licence pour circuler
                </p>
            </a>
        </div>
