...
<section class="bg-transparent my-20">
    <div class="flex rounded-xl justify-center min-h-screen">
        ...
        <div class="flex relative z-50 bg-black items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
            <img src="{{ asset('commune_6.jpg') }}"
                class="absolute h-full w-full opacity-50 z-0 top-0 bottom-0 right-0 left-0" alt="" srcset="">
