            ...
            <div class="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                <div class="w-full">
                    <h1 class="text-2xl font-semibold tracking-wider text-gray-800 capitalize">
                        Demande d'autorisation de circuler pour les particulier
                    </h1>
                    ...
                    <form class="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                        ...
                        <div class="my-5">
                            <label for="image" class="block text-sm text-gray-500">Photo de la plaque d'immatriculation</label>
                        ...
                        <div class="my-5">
                            <label for="image" class="block text-sm text-gray-500">Photo d'un justificatif de profession</label>
                        ...
                        <div class="my-5">
                            <label for="image" class="block text-sm text-gray-500">Photo de l'attestation d'immatriculation</label>
